...
def main():
    ...
    param_sets = [
        {
            'hidden_dims': [128, 64, 32],       # Best performing architecture
            'latent_dim': 20,                    # Slightly increased
            'dropout': 0.06,                     # Further reduced
            'learning_rate': 0.0018,             # Slightly increased
            'batch_size': 20,                    # Slightly reduced
            'n_epochs': 70                       # More epochs
        },
        {
            'hidden_dims': [128, 64, 32],       # Same architecture
            'latent_dim': 16,                    # Slightly reduced
            'dropout': 0.1,                      # Increased
            'learning_rate': 0.0012,             # Slightly reduced
            'batch_size': 28,                    # Increased
            'n_epochs': 65                       # Slightly more epochs
        },
        {
            'hidden_dims': [96, 48, 24],        # Slightly smaller
            'latent_dim': 18,                    # Same as best
            'dropout': 0.08,                     # Same as best
            'learning_rate': 0.0015,             # Same as best
            'batch_size': 24,                    # Same as best
            'n_epochs': 60                       # Same as best
        }
    ]
